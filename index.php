...
<head>
  ...
  <meta name="description" content="Global Code — Start-up tecnológica colombiana especializada en desarrollo de software, automatización de procesos e inteligencia artificial." />
  <meta name="theme-color" content="#000F2A" />
  <title>Global Code · Transformamos Negocios con Tecnología</title>
...
<body>
  ...
  ══════════════════════════════════════════════════════════ -->
  <a id="whatsapp-float"
     href="https://wa.me/573000000000?text=Hola%20Global%20Code%2C%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20sus%20servicios."
     target="_blank"
  ...
  <main>
    ...
    <section id="portafolio" aria-label="Portafolio de proyectos">
      ...
      <div class="portafolio-grid">
        ...
        <!-- Proyecto 01 — columna izquierda grande -->
        ...
        <!-- Columna derecha: dos proyectos apilados -->
        <div class="col-right">
      ...
      <div class="contacto-grid">
        ...
        <div>
          ...
          <a href="https://wa.me/573000000000" target="_blank" rel="noopener noreferrer"
            ...
            <span class="contacto-dato-text">+57 300 000 0000 · WhatsApp</span>
          </a>

          <a href="mailto:info@globalcode.com.co"
            ...
            <span class="contacto-dato-text">info@globalcode.com.co</span>
          </a>
        </div>
  ...
  <footer id="footer">
    <div class="footer-grid">
      ...
      <div>
        ...
        <p class="footer-contact-item">+57 300 000 0000</p>
        <p class="footer-contact-item">info@globalcode.com.co</p>
